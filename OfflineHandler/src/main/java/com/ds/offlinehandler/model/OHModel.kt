...
data class ApiBody(@SerializedName("Workflow_Id") val workflow_id: Int,
                   @SerializedName("Workflow_Version") val workflow_version: Int,
                   @SerializedName("Apk_Version") val apk_version: String,
...
data class StagesContent(@SerializedName("Id") val Id: Int,
                         ...
                         @SerializedName("AllowOffline") val AllowOffline: Boolean,
...
//Request
data class RequestContent(@SerializedName("Body") val Body: ApiBody,
...
//Modelo para el usuario (offline product stages)
data class OfflineProductData(@SerializedName("stageId") val stageId: Int,
                            @SerializedName("name") val name: String,
                            @SerializedName("json") val json: String,
                            @SerializedName("endpoint") val endpoint: String,
                            @SerializedName("seq") val seq: Int,
